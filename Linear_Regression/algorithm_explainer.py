...
GITHUB_NOTEBOOK_URL = "https://raw.githubusercontent.com/rakeshravikumar-ML/ml_algorithm_helper/main/Linear_Regression/Simple_Linear_Model.ipynb"

def download_notebook():
    """
    Downloads the notebook from GitHub if it is not already available in Colab.
    """
    notebook_path = "/content/Simple_Linear_Model.ipynb"
...
def get_project_steps():
    ...
    return {
        ...
        2: "## **2. Importing Data**",
        3: "## **3. Basic Exploratory Data Analysis**",
        4: "## **4. Building The Model**",
        5: "## **5. Analyzing Model Performance**",
        6: "## **6. Visualizing the Model Fit**",
        7: "## **7. Residual Analysis**",
        8: "## **8. Comparing Actual vs. Predicted Values**"
    }
