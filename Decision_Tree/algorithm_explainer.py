...
def get_project_steps():
    ...
    return {
        ...
        2: "## **2. Understanding the Structure of a Decision Tree**",
        3: "## **3. How a Decision Tree Works?**",
        4: "## **4. Impurity Measures: Entropy & Gini Impurity**",
        5: "## **5. Information Gain & Splitting Criteria**",
        6: "## **6. Overfitting & Pruning**",
        7: "## **7. When & How to Use Decision Trees**",
        8: "## **8. Advantages & Disadvantages of Decision Trees**",
        9: "## **9. Implementing Decision Tree in Python**"
    }
